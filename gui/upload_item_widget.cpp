...
void upload_item_widget::setup_ui()
{
    ...
    file_name_label_ = new QLabel("File Name");
    ...
    auto *status_panel_widget = new QWidget();
    auto *status_panel_layout = new QHBoxLayout(status_panel_widget);
    status_panel_layout->setContentsMargins(0, 0, 0, 0);
    status_panel_layout->setSpacing(10);
    status_panel_layout->setAlignment(Qt::AlignVCenter);
    ...
    progress_bar_->setMinimumWidth(100);
    progress_bar_->setFixedHeight(8);
    progress_bar_->setTextVisible(false);
    percent_label_ = new QLabel("100%");
    time_label_ = new QLabel("00:00");
    progress_layout->addWidget(progress_bar_, 0, 0);
    progress_layout->addWidget(percent_label_, 0, 1);
    progress_layout->addWidget(time_label_, 1, 0, 1, 1, Qt::AlignLeft);

    speed_label_ = new QLabel("0.0 MB/s");
    speed_label_->setMinimumWidth(80);
    ...
    status_panel_layout->setSpacing(45);
    status_panel_layout->addWidget(progress_widget, 1);
    status_panel_layout->addWidget(speed_label_, 0);
    status_panel_layout->addWidget(actions_widget, 0);

    main_layout->addWidget(file_info_widget, 1);
    main_layout->addWidget(status_panel_widget, 1);
}
...
void upload_item_widget::set_data(const leaf::upload_event &task)
{
    ...
    percent_label_->setText(QString::number(percentage) + "%");
